...
public class TelemetryController {
    ...
    public ResponseEntity<ApiResponse<Page<TelemetryResponse>>> history(
        ...
        // RN12: Validar acesso do usuario ao guincho
        resourceOwnershipService.validarAcessoGuincho(id);
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Ultima telemetria carregada com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = TelemetryResponse.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Guincho nao encontrado ou sem registros de telemetria"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Usuario nao autenticado")
    })
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Alertas carregados com sucesso",
